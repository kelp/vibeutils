...
| --label | -- | yes | yes | yes | yes | SHOULD |
| --line-buffered | -- | yes | yes | yes | yes | SHOULD |
| --null | -- | yes | yes | yes | yes | SHOULD |
| --binary-files | -- | yes | yes | yes | yes | SHOULD |
| --mmap | -- | yes | -- | -- | yes | SHOULD |
| --group-separator | -- | -- | -- | yes | -- | WONT |
| --no-group-separator | -- | -- | -- | yes | -- | WONT |
| --no-ignore-case | -- | -- | -- | yes | -- | WONT |
| --include-dir | -- | yes | -- | -- | yes | SHOULD |
