...
| --compress-program | - | yes | yes | yes | - | MUST |
| --debug | - | yes | yes | yes | - | MUST |
| --files0-from | - | yes | yes | yes | - | MUST |
| --parallel | - | yes | yes | yes | - | MUST |
| --random-source | - | yes | yes | yes | - | MUST |
| --heapsort | - | yes | yes | - | - | MUST |
| --mergesort | - | yes | yes | - | - | MUST |
| --mmap | - | yes | yes | - | - | MUST |
| --qsort | - | yes | yes | - | - | MUST |
| --radixsort | - | yes | yes | - | - | MUST |
| --sort=WORD | - | - | - | yes | - | WONT |
